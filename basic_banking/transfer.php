		 ...
		 function random_function()
            {
				...
				if(a==="Salman"){
				 var arr=["Priti","Anupam","Ashutosh","Amit","Sukriti","Priyanshu","Jitendra","Prabhakar","Deepak"];
					...
					var arr=["Salman","Anupam","Ashutosh","Amit","Sukriti","Priyanshu","Jitendra","Prabhakar","Deepak"];
				}
				else if(a==="Anupam"){
					var arr=["Salman","Priti","Ashutosh","Amit","Sukriti","Priyanshu","Jitendra","Prabhakar","Deepak"];
				}
				else if(a==="Ashutosh"){
					var arr=["Salman","Priti","Anupam","Amit","Sukriti","Priyanshu","Jitendra","Prabhakar","Deepak"];
				 }
				 else if(a==="Amit"){
					var arr=["Salman","Priti","Anupam","Ashutosh","Sukriti","Priyanshu","Jitendra","Prabhakar","Deepak"];
				 }
				 else if(a==="Sukriti"){
                                         var arr=["Salman","Priti","Anupam","Ashutosh","Amit","Priyanshu","Jitendra","Prabhakar","Deepak"];
				 }
				 else if(a==="Priyanshu"){
					var arr=["Salman","Priti","Anupam","Ashutosh","Amit","Sukriti","Jitendra","Prabhakar","Deepak"];
				 }
				 else if(a==="Jitendra"){
					var arr=["Salman","Priti","Anupam","Ashutosh","Amit","Sukriti","Priyanshu","Prabhakar","Deepak"];
				 }
				 else if(a==="Prabhakar"){
					var arr=["Salman","Priti","Anupam","Ashutosh","Amit","Sukriti","Priyanshu","Jitendra","Deepak"];
				 }
				 else if(a==="Shubham"){
				        var arr=["Salman","Priti","Anupam","Ashutosh","Amit","Sukriti","Priyanshu","Jitendra","Prabhakar"];
